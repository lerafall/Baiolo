/* Foxfire Hollow — level data.
 *
 * Levels are declared with a tiny op DSL instead of ASCII art so every gap and
 * ledge height is an exact number we can validate (see scripts/validate-levels).
 * Tile codes: 0 empty · 1 solid · 2 one-way · 3 thorn · 4 crumble · 5 gloom · 6 updraft
 */
(() => {
  "use strict";
  ...
  /** @typedef {["floor"|"block"|"ledge"|"plat"|"thorns"|"crumble"|"gloom"|"updraft", ...number[]]} Op */
  ...
  const LEVELS = [
...

    {
      ...
      ops: [
        ["spawn", 2, 25],
        ["hint", 5, 24, "Shift / X — ember dash", "Refill it by touching ground"],

        ["floor", 0, 14, 26],
        ["seedRow", 7, 9, 25],
        ["bloom", 12, 24],

        // dash gap — 6 tiles, wider than a running jump
        ["seedRow", 15, 20, 24],
        ["floor", 21, 30, 26],
        ["bug", 25, 25],
        ["thorns", 27, 25, 2],

        // climb on one-way fern platforms
        ["plat", 22, 23, 4],
        ["seedRow", 23, 24, 22],
        ["plat", 28, 20, 4],
        ["seed", 29, 19],
        ...
        // side pocket with the moonpetal
        ["ledge", 45, 12, 3],
        ["ledge", 49, 10, 4],
        ["petal", 51, 9],
...

    {
      ...
      ops: [
        ...
        ["floor", 0, 12, 20],
        ["seedRow", 6, 8, 19],
        ["hint", 4, 18, "Dash straight through a gloomwisp", "to burst it and refill your ember"],
        ["wisp", 15, 17, 3, 1],
        ["bloom", 11, 19],
...

    {
      ...
      ops: [
        ["spawn", 2, 29],
        ["floor", 0, 12, 30],
        ["hint", 4, 28, "Press into a wall while falling", "Jump again to climb the chimney"],
        ["seedRow", 6, 8, 29],
        ["bloom", 11, 29],

        // chimney one: walk in under the hanging pillar, wall-jump out of the top
        ["floor", 13, 20, 30],
        ["block", 13, 18, 13, 27],
        ["block", 18, 18, 18, 29],
        ["seed", 15, 28],
        ...
        // chimney two — hanging stalactite columns, the moonpetal waits on top
        ["floor", 43, 49, 16],
        ["block", 44, 6, 44, 13],
        ["block", 48, 6, 48, 13],
        ["seed", 46, 12],
...

    {
      ...
      ops: [
        ...
        ["floor", 0, 10, 20],
        ["seedRow", 5, 7, 19],
        ["hint", 3, 18, "Vents lift you on hot air", "Steer while you rise"],
...

    {
      ...
      ops: [
        ...
        // wall-jump chimney with thorn ledges
        ["block", 44, 6, 44, 21],
        ["block", 49, 10, 49, 21],
        ["floor", 45, 48, 20],
        ["seed", 46, 18],
...

    {
      ...
      ops: [
        ...
        ["floor", 0, 12, 34],
        ["seedRow", 6, 8, 33],
        ["hint", 4, 32, "The canopy only goes up", "Shrooms, vents and roots — chain them"],
        ["shroom", 11, 33],
...

    {
      ...
      ops: [
        ["spawn", 2, 19],
        ["hint", 4, 18, "The gloom is coming. Don't look back.", "Blooms keep your ember lit — run."],
        ["floor", 0, 14, 20],
        ["seedRow", 6, 9, 19],
        ["bloom", 13, 19],
    ...
    for (const op of def.ops) {
      ...
      switch (kind) {
        ...
        case "check":
          ...
          break;
        case "bug":
          entities.push({ type: "bug", x: op[1], y: op[2] });
          break;
        case "wisp":
  ...
  if (typeof window !== "undefined") window.FoxfireLevels = api;
})();
