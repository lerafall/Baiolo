...
export type HtmlWorkshopHandle = {
  capturePreview: () => PreviewInsight;
};

export const HtmlWorkshop = forwardRef<HtmlWorkshopHandle, HtmlWorkshopProps>(
  function HtmlWorkshop(
    {
      starterId = "game",
      files,
      onStarterChange,
    ...
    useImperativeHandle(ref, () => ({
      capturePreview: () => capturePreviewInsight(iframeRef.current, files),
    }));
